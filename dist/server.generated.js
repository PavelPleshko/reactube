...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _express2 = _interopRequireDefault(_express);\n\nvar _channel = __webpack_require__(/*! ./channel.controller */ \"./server/app/channel/channel.controller.js\");\n\nvar _channel2 = _interopRequireDefault(_channel);\n\nvar _auth = __webpack_require__(/*! ../auth/auth.controller */ \"./server/app/auth/auth.controller.js\");\n\nvar _auth2 = _interopRequireDefault(_auth);\n\nvar _channelTopic = __webpack_require__(/*! ./channel-topic/channel-topic.routes */ \"./server/app/channel/channel-topic/channel-topic.routes.js\");\n\nvar _channelTopic2 = _interopRequireDefault(_channelTopic);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst router = _express2.default.Router();\n\nrouter.route('/channels/create').post(_auth2.default.requireSignin, _channel2.default.create);\n\nrouter.route('/channels/subscriptions').get(_auth2.default.requireSignin, _channel2.default.listSubscriptions);\n\nrouter.route('/channels/:channelId/media').get(_channel2.default.listChannelMedia);\n\nrouter.route('/channels/:channelId/subscribe').post(_auth2.default.requireSignin, _channel2.default.notOwner, _channel2.default.subscribe);\n\nrouter.route('/channels/:channelId/unsubscribe').post(_auth2.default.requireSignin, _channel2.default.notOwner, _channel2.default.unsubscribe);\n\nrouter.route('/channels/:channelId').patch(_auth2.default.requireSignin, _channel2.default.updateChannel);\n\nrouter.route('/channels/:channelSlug').get(_channel2.default.readBySlug);\n\nrouter.param('channelId', _channel2.default.findById);\n\nrouter.use('/channels', _channelTopic2.default);\n\n// router.route('/users/profile/update')\n//   .put(authCtrl.requireSignin,userCtrl.update)\n\n// router.route('/users/profile/watchlater')\n//   .put(authCtrl.requireSignin,userCtrl.addWatchlater)\n\n\nexports.default = router;\n\n//# sourceURL=webpack:///./server/app/channel/channel.routes.js?");
...
/***/ "./server/app/interest/interest.controller.js":
/*!****************************************************!*\
  !*** ./server/app/interest/interest.controller.js ***!
  \****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.channelRoutes = exports.commentRoutes = exports.tagRoutes = exports.categoryRoutes = exports.mediaRoutes = exports.userRoutes = exports.authRoutes = undefined;\n\nvar _auth = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './auth/auth.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _auth2 = _interopRequireDefault(_auth);\n\nvar _user = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './user/user.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _user2 = _interopRequireDefault(_user);\n\nvar _media = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './media/media.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _media2 = _interopRequireDefault(_media);\n\nvar _category = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './category/category.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _category2 = _interopRequireDefault(_category);\n\nvar _tag = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './tag/tag.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _tag2 = _interopRequireDefault(_tag);\n\nvar _comment = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './comment/comment.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _comment2 = _interopRequireDefault(_comment);\n\nvar _channel = __webpack_require__(!(function webpackMissingModule() { var e = new Error(\"Cannot find module './channel/channel.routes'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\n\nvar _channel2 = _interopRequireDefault(_channel);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.authRoutes = _auth2.default;\nexports.userRoutes = _user2.default;\nexports.mediaRoutes = _media2.default;\nexports.categoryRoutes = _category2.default;\nexports.tagRoutes = _tag2.default;\nexports.commentRoutes = _comment2.default;\nexports.channelRoutes = _channel2.default;\n\n//# sourceURL=webpack:///./server/app/interest/interest.controller.js?");
...
/***/ "./server/app/user/token.model.js":
/*!****************************************!*\
  !*** ./server/app/user/token.model.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _express2 = _interopRequireDefault(_express);\n\nvar _user = __webpack_require__(/*! ./user.controller */ \"./server/app/user/user.controller.js\");\n\nvar _user2 = _interopRequireDefault(_user);\n\nvar _auth = __webpack_require__(/*! ../auth/auth.controller */ \"./server/app/auth/auth.controller.js\");\n\nvar _auth2 = _interopRequireDefault(_auth);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst router = _express2.default.Router();\n\nrouter.route('/users/signup').post(_user2.default.create);\n\nrouter.route('/users/verify/:token').get(_user2.default.verify);\n\nrouter.route('/users/continue-watching/:mediaId').post(_auth2.default.requireSignin, _user2.default.addToContinueWatching);\n\nrouter.route('/users/media-completed/:mediaId').post(_auth2.default.requireSignin, _user2.default.removeFromContinueWatching);\n\nrouter.route('/users/profile/update').patch(_auth2.default.requireSignin, _user2.default.update);\n\nrouter.route('/users/profile/watchlater').put(_auth2.default.requireSignin, _user2.default.addWatchlater);\n\nrouter.route('/users/history/clear').put(_auth2.default.requireSignin, _user2.default.clearHistory);\n\nrouter.route('/users/:userId/channels').get(_user2.default.listUserChannels);\n\nexports.default = router;\n\n//# sourceURL=webpack:///./server/app/user/user.routes.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.getResourceIdFromLink = exports.removeResourceFromCloudinary = exports.uploadFileFromPathToCloudinary = undefined;\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _cloudinary = __webpack_require__(/*! cloudinary */ \"cloudinary\");\n\nvar _cloudinary2 = _interopRequireDefault(_cloudinary);\n\nvar _config = __webpack_require__(/*! ../config/config */ \"./server/config/config.js\");\n\nvar _config2 = _interopRequireDefault(_config);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nconst cloudinaryConfig = _config2.default.cloudinary;\n\nconst getResourceIdFromLink = (link, resourceType = 'image') => {\n  const imagePostfix = 'jpg|jpeg|png';\n  const videoPostfix = 'mp4|mpeg|avi|3gp';\n  const postfix = resourceType === 'image' ? imagePostfix : videoPostfix;\n  const regex = new RegExp(`(?:(upload.+))(?:\\/)(.+)(?:\\.(${postfix}))(\\/)*$`, `gm`);\n  let result = regex.exec(link);\n  if (result) {\n    result = result.filter(item => item && typeof item === 'string' && !item.includes('/') && !postfix.includes(item));\n    if (result) {\n      result = result[0];\n      return result;\n    } else {\n      return false;\n    }\n  }\n};\n\nconst removeResourceFromCloudinary = (() => {\n  var _ref = _asyncToGenerator(function* (resourcesArr, resourceType = 'image', config = cloudinaryConfig) {\n    const result = yield _cloudinary2.default.v2.api.delete_resources(resourcesArr, _extends({}, config, { resource_type: resourceType }));\n    return result;\n  });\n\n  return function removeResourceFromCloudinary(_x) {\n    return _ref.apply(this, arguments);\n  };\n})();\n\nconst uploadFileFromPathToCloudinary = (path, key, resourceType = 'image', previousPath) => {\n  return new Promise((resolve, reject) => {\n    _cloudinary2.default.v2.uploader.upload(path, cloudinaryConfig, (() => {\n      var _ref2 = _asyncToGenerator(function* (err, result) {\n        if (err) {\n          reject(err);\n        }\n        if (result) {\n          if (previousPath) {\n            //TODO make it safer here with Regexp\n            const previousId = getResourceIdFromLink(previousPath, resourceType);\n            if (previousId) {\n              const cloudDelete = yield removeResourceFromCloudinary([previousId], resourceType);\n            }\n          }\n          resolve(result);\n        }\n      });\n\n      return function (_x2, _x3) {\n        return _ref2.apply(this, arguments);\n      };\n    })());\n  });\n};\n\nexports.uploadFileFromPathToCloudinary = uploadFileFromPathToCloudinary;\nexports.removeResourceFromCloudinary = removeResourceFromCloudinary;\nexports.getResourceIdFromLink = getResourceIdFromLink;\n\n//# sourceURL=webpack:///./server/helpers/cloudinaryManager.js?");
...
/***/ "./server/helpers/mongoose-aggregator.js":
/*!***********************************************!*\
  !*** ./server/helpers/mongoose-aggregator.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.verifyToken = exports.createJwtToken = undefined;\n\nvar _jsonwebtoken = __webpack_require__(/*! jsonwebtoken */ \"jsonwebtoken\");\n\nvar _jsonwebtoken2 = _interopRequireDefault(_jsonwebtoken);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst DEFAULT_EXPIRATION = 60 * 60 * 24;\n\nconst createJwtToken = (secret, payload, expires = DEFAULT_EXPIRATION) => {\n\tconst token = _jsonwebtoken2.default.sign(payload, secret, { expiresIn: expires });\n\treturn token;\n};\n\nconst verifyToken = (token, secret) => {\n\treturn new Promise((resolve, reject) => {\n\t\t_jsonwebtoken2.default.verify(token, secret, (err, res) => {\n\t\t\tif (err) {\n\t\t\t\tswitch (err.name) {\n\t\t\t\t\tcase 'TokenExpiredError':\n\t\t\t\t\t\terr.message = 'token has expired';\n\t\t\t\t\t\terr.code = 401;\n\t\t\t\t\t\tbreak;\n\t\t\t\t\tdefault:\n\t\t\t\t\t\terr.message = 'Unknown error occurred. Try again later';\n\t\t\t\t\t\terr.code = 500;\n\t\t\t\t}\n\t\t\t\treject(err);\n\t\t\t} else {\n\t\t\t\tresolve(res);\n\t\t\t}\n\t\t});\n\t});\n};\n\nexports.createJwtToken = createJwtToken;\nexports.verifyToken = verifyToken;\n\n//# sourceURL=webpack:///./server/helpers/tokenHelper.js?");

/***/ }),

/***/ "./server/middlewares/multiparser.js":
/*!*******************************************!*\
  !*** ./server/middlewares/multiparser.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _extend = __webpack_require__(/*! lodash/extend */ \"lodash/extend\");\n\nvar _extend2 = _interopRequireDefault(_extend);\n\nvar _formidable = __webpack_require__(/*! formidable */ \"formidable\");\n\nvar _formidable2 = _interopRequireDefault(_formidable);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst MultiParser = () => {\n  return (req, res, next) => {\n    const form = new _formidable2.default.IncomingForm();\n    form.parse(req, (err, fields, files) => {\n      if (err) next(err);else {\n        req.body = (0, _extend2.default)(req.body, fields);\n        req.files = files;\n        next();\n      }\n    });\n  };\n};\n\nexports.default = MultiParser;\n\n//# sourceURL=webpack:///./server/middlewares/multiparser.js?");

/***/ }),

/***/ "./server/seneca/index.js":
/*!********************************!*\
  !*** ./server/seneca/index.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.emailService = undefined;\n\nvar _seneca = __webpack_require__(/*! seneca */ \"seneca\");\n\nvar _seneca2 = _interopRequireDefault(_seneca);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst emailService = (0, _seneca2.default)().client({ host: '127.0.0.1', port: 4000 });\n\nexports.emailService = emailService;\n\n//# sourceURL=webpack:///./server/seneca/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _reactRouterDom = __webpack_require__(/*! react-router-dom */ \"react-router-dom\");\n\nvar _List = __webpack_require__(/*! @material-ui/core/List */ \"@material-ui/core/List\");\n\nvar _List2 = _interopRequireDefault(_List);\n\nvar _styles = __webpack_require__(/*! @material-ui/core/styles */ \"@material-ui/core/styles\");\n\nvar _Avatar = __webpack_require__(/*! @material-ui/core/Avatar */ \"@material-ui/core/Avatar\");\n\nvar _Avatar2 = _interopRequireDefault(_Avatar);\n\nvar _ListItem = __webpack_require__(/*! @material-ui/core/ListItem */ \"@material-ui/core/ListItem\");\n\nvar _ListItem2 = _interopRequireDefault(_ListItem);\n\nvar _ListItemIcon = __webpack_require__(/*! @material-ui/core/ListItemIcon */ \"@material-ui/core/ListItemIcon\");\n\nvar _ListItemIcon2 = _interopRequireDefault(_ListItemIcon);\n\nvar _ListItemText = __webpack_require__(/*! @material-ui/core/ListItemText */ \"@material-ui/core/ListItemText\");\n\nvar _ListItemText2 = _interopRequireDefault(_ListItemText);\n\nvar _ListSubheader = __webpack_require__(/*! @material-ui/core/ListSubheader */ \"@material-ui/core/ListSubheader\");\n\nvar _ListSubheader2 = _interopRequireDefault(_ListSubheader);\n\nvar _Image = __webpack_require__(/*! @material-ui/icons/Image */ \"@material-ui/icons/Image\");\n\nvar _Image2 = _interopRequireDefault(_Image);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst styles = theme => ({\n  title: {\n    textOverflow: 'ellipsis',\n    overflow: 'hidden',\n    whiteSpace: 'nowrap'\n  }\n});\n\nconst subscriptions = props => {\n  const { subscriptions, classes } = props;\n\n  return _react2.default.createElement(\n    _List2.default,\n    { subheader: _react2.default.createElement(\n        _ListSubheader2.default,\n        { component: 'div' },\n        'Subscriptions'\n      ) },\n    subscriptions && subscriptions.map(item => {\n      return _react2.default.createElement(\n        _reactRouterDom.Link,\n        { key: item._id, to: `/channel/${item.slug}` },\n        _react2.default.createElement(\n          _ListItem2.default,\n          { button: true },\n          item.iconImage ? _react2.default.createElement(_Avatar2.default, { src: item.iconImage }) : _react2.default.createElement(\n            _ListItemIcon2.default,\n            null,\n            _react2.default.createElement(_Image2.default, null)\n          ),\n          _react2.default.createElement(_ListItemText2.default, { primary: item.title, classes: { primary: classes.title } })\n        )\n      );\n    })\n  );\n};\n\nexports.default = (0, _styles.withStyles)(styles)(subscriptions);\n\n//# sourceURL=webpack:///./src/components/core/DrawerNav/drawerNav/Subscriptions.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createAction = __webpack_require__(/*! ../utils/create-action */ \"./src/store/states/utils/create-action.js\");\n\nvar _createAction2 = _interopRequireDefault(_createAction);\n\nvar _channel = __webpack_require__(/*! ./channel.types */ \"./src/store/states/channel/channel.types.js\");\n\nvar _channel2 = _interopRequireDefault(_channel);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n//login\nconst getChannelsTopicsRequest = (0, _createAction2.default)(_channel2.default.GET_CHANNELS_TOPICS_REQUEST);\nconst getChannelsTopicsSuccess = (0, _createAction2.default)(_channel2.default.GET_CHANNELS_TOPICS_SUCCESS, 'payload');\nconst getChannelsTopicsError = (0, _createAction2.default)(_channel2.default.GET_CHANNELS_TOPICS_ERROR, 'payload');\n\nconst getUserSubscriptionsRequest = (0, _createAction2.default)(_channel2.default.GET_USER_SUBSCRIPTIONS_REQUEST);\nconst getUserSubscriptionsSuccess = (0, _createAction2.default)(_channel2.default.GET_USER_SUBSCRIPTIONS_SUCCESS, 'payload');\nconst getUserSubscriptionsError = (0, _createAction2.default)(_channel2.default.GET_USER_SUBSCRIPTIONS_ERROR, 'payload');\n\nconst createNewChannelRequest = (0, _createAction2.default)(_channel2.default.CREATE_NEW_CHANNEL_REQUEST);\nconst createNewChannelSuccess = (0, _createAction2.default)(_channel2.default.CREATE_NEW_CHANNEL_SUCCESS, 'payload');\nconst createNewChannelError = (0, _createAction2.default)(_channel2.default.CREATE_NEW_CHANNEL_ERROR, 'payload');\n\nconst getChannelBySlugRequest = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_BY_SLUG_REQUEST);\nconst getChannelBySlugSuccess = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_BY_SLUG_SUCCESS, 'payload');\nconst getChannelBySlugError = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_BY_SLUG_ERROR, 'payload');\n\nconst getChannelMediaRequest = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_MEDIA_REQUEST);\nconst getChannelMediaSuccess = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_MEDIA_SUCCESS, 'payload');\nconst getChannelMediaError = (0, _createAction2.default)(_channel2.default.GET_CHANNEL_MEDIA_ERROR, 'payload');\n\nconst updateChannelRequest = (0, _createAction2.default)(_channel2.default.UPDATE_CHANNEL_REQUEST);\nconst updateChannelSuccess = (0, _createAction2.default)(_channel2.default.UPDATE_CHANNEL_SUCCESS, 'payload');\nconst updateChannelError = (0, _createAction2.default)(_channel2.default.UPDATE_CHANNEL_ERROR, 'payload');\n\nconst subscribeToChannelRequest = (0, _createAction2.default)(_channel2.default.SUBSCRIBETO_CHANNEL_REQUEST);\nconst subscribeToChannelSuccess = (0, _createAction2.default)(_channel2.default.SUBSCRIBETO_CHANNEL_SUCCESS, 'payload');\nconst subscribeToChannelError = (0, _createAction2.default)(_channel2.default.SUBSCRIBETO_CHANNEL_ERROR, 'payload');\nconst unsubscribeFromChannelRequest = (0, _createAction2.default)(_channel2.default.UNSUBSCRIBEFROM_CHANNEL_REQUEST);\nconst unsubscribeFromChannelSuccess = (0, _createAction2.default)(_channel2.default.UNSUBSCRIBEFROM_CHANNEL_SUCCESS, 'payload');\nconst unsubscribeFromChannelError = (0, _createAction2.default)(_channel2.default.UNSUBSCRIBEFROM_CHANNEL_ERROR, 'payload');\n\nexports.default = {\n\tgetChannelsTopicsRequest, getChannelsTopicsSuccess, getChannelsTopicsError,\n\tgetUserSubscriptionsRequest, getUserSubscriptionsSuccess, getUserSubscriptionsError,\n\n\tcreateNewChannelRequest, createNewChannelSuccess, createNewChannelError,\n\n\tgetChannelBySlugRequest, getChannelBySlugSuccess, getChannelBySlugError,\n\n\tgetChannelMediaRequest, getChannelMediaSuccess, getChannelMediaError,\n\n\tupdateChannelRequest, updateChannelSuccess, updateChannelError,\n\n\tsubscribeToChannelRequest, subscribeToChannelSuccess, subscribeToChannelError,\n\tunsubscribeFromChannelRequest, unsubscribeFromChannelSuccess, unsubscribeFromChannelError\n};\n\n//# sourceURL=webpack:///./src/store/states/channel/channel.actions.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.subscribeToChannel = exports.unsubscribeFromChannel = exports.getChannelBySlug = exports.updateChannel = exports.createNewChannel = exports.getChannelMedia = exports.getUserSubscriptions = exports.getChannelsTopics = undefined;\n\nvar _actions = __webpack_require__(/*! connected-react-router/lib/actions */ \"connected-react-router/lib/actions\");\n\nvar _channel = __webpack_require__(/*! ./channel.api */ \"./src/store/states/channel/channel.api.js\");\n\nvar channelApiCalls = _interopRequireWildcard(_channel);\n\nvar _channel2 = __webpack_require__(/*! ./channel.actions */ \"./src/store/states/channel/channel.actions.js\");\n\nvar _channel3 = _interopRequireDefault(_channel2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nconst getChannelsTopics = () => {\n\treturn dispatch => {\n\t\tdispatch(_channel3.default.getChannelsTopicsRequest());\n\t\tchannelApiCalls.getChannelsTopics().then(response => {\n\t\t\tlet topics = response.data.channelTopics;\n\t\t\tdispatch(_channel3.default.getChannelsTopicsSuccess(topics));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.getChannelsTopicsError(error.message));\n\t\t});\n\t};\n};\n\nconst getChannelMedia = channelId => {\n\treturn dispatch => {\n\t\tdispatch(_channel3.default.getChannelMediaRequest());\n\t\tchannelApiCalls.getChannelMedia(channelId).then(response => {\n\t\t\tlet media = response.data.media;\n\t\t\tdispatch(_channel3.default.getChannelMediaSuccess(media));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.getChannelMediaError(error.message));\n\t\t});\n\t};\n};\n\nconst getUserSubscriptions = () => {\n\treturn dispatch => {\n\t\tdispatch(_channel3.default.getUserSubscriptionsRequest());\n\t\tchannelApiCalls.getUserSubscriptions().then(response => {\n\t\t\tlet subscriptions = response.data.channels;\n\t\t\tdispatch(_channel3.default.getUserSubscriptionsSuccess(subscriptions));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.getUserSubscriptionsError(error.message));\n\t\t});\n\t};\n};\n\nconst createNewChannel = channelData => {\n\treturn (dispatch, getState) => {\n\t\tdispatch(_channel3.default.createNewChannelRequest());\n\t\tconst csrfToken = getState().csrf;\n\t\tchannelApiCalls.createNewChannel({ channelData, csrfToken }).then(response => {\n\t\t\tconst newChannel = response.data.newChannel;\n\t\t\tdispatch(_channel3.default.createNewChannelSuccess(newChannel));\n\t\t\tconst slug = newChannel.slug;\n\t\t\tdispatch((0, _actions.push)(`/channel/${slug}`));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.createNewChannelError(error.message));\n\t\t});\n\t};\n};\n\nconst updateChannel = (channelPartial, channelId) => {\n\treturn (dispatch, getState) => {\n\t\tdispatch(_channel3.default.updateChannelRequest());\n\t\tconst csrfToken = getState().csrf;\n\t\tchannelApiCalls.updateChannel({ channelPartial, channelId, csrfToken }).then(response => {\n\t\t\tconst updatedChannel = response.data.updatedChannel;\n\t\t\tdispatch(_channel3.default.updateChannelSuccess(updatedChannel));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.updateChannelError(error.message));\n\t\t});\n\t};\n};\n\nconst subscribeToChannel = channelId => {\n\treturn (dispatch, getState) => {\n\t\tdispatch(_channel3.default.subscribeToChannelRequest());\n\t\tconst csrfToken = getState().csrf;\n\t\tchannelApiCalls.subscribeToChannel({ channelId, csrfToken }).then(response => {\n\t\t\tconst updatedChannel = response.data.updatedChannel;\n\t\t\tdispatch(_channel3.default.subscribeToChannelSuccess(updatedChannel));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.subscribeToChannelError(error.message));\n\t\t});\n\t};\n};\n\nconst unsubscribeFromChannel = channelId => {\n\treturn (dispatch, getState) => {\n\t\tdispatch(_channel3.default.unsubscribeFromChannelRequest());\n\t\tconst csrfToken = getState().csrf;\n\t\tchannelApiCalls.unsubscribeFromChannel({ channelId, csrfToken }).then(response => {\n\t\t\tconst updatedChannel = response.data.updatedChannel;\n\t\t\tdispatch(_channel3.default.unsubscribeFromChannelSuccess(updatedChannel));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.unsubscribeFromChannelError(error.message));\n\t\t});\n\t};\n};\n\nconst getChannelBySlug = slug => {\n\treturn dispatch => {\n\t\tdispatch(_channel3.default.getChannelBySlugRequest());\n\t\tchannelApiCalls.getChannelBySlug(slug).then(response => {\n\t\t\tlet channel = response.data.channel;\n\t\t\tdispatch(_channel3.default.getChannelBySlugSuccess(channel));\n\t\t}).catch(error => {\n\t\t\tdispatch(_channel3.default.getChannelBySlugError(error.message));\n\t\t});\n\t};\n};\n\nexports.getChannelsTopics = getChannelsTopics;\nexports.getUserSubscriptions = getUserSubscriptions;\nexports.getChannelMedia = getChannelMedia;\nexports.createNewChannel = createNewChannel;\nexports.updateChannel = updateChannel;\nexports.getChannelBySlug = getChannelBySlug;\nexports.unsubscribeFromChannel = unsubscribeFromChannel;\nexports.subscribeToChannel = subscribeToChannel;\n\n//# sourceURL=webpack:///./src/store/states/channel/channel.operations.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _channel = __webpack_require__(/*! ./channel.types */ \"./src/store/states/channel/channel.types.js\");\n\nvar _channel2 = _interopRequireDefault(_channel);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst initialState = {\n\tprocessing: false,\n\tisError: false,\n\tdata: null,\n\tsingle: null,\n\tsubscriptions: null,\n\ttopics: []\n};\n\nconst channelReducer = (state = initialState, action) => {\n\tconst { type, payload } = action;\n\tswitch (type) {\n\t\tcase _channel2.default.GET_CHANNELS_TOPICS_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: true,\n\t\t\t\tisError: null\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNELS_TOPICS_SUCCESS:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\ttopics: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNELS_TOPICS_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_USER_SUBSCRIPTIONS_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: true,\n\t\t\t\tisError: null\n\t\t\t});\n\n\t\tcase _channel2.default.GET_USER_SUBSCRIPTIONS_SUCCESS:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tsubscriptions: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_USER_SUBSCRIPTIONS_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tcase _channel2.default.CREATE_NEW_CHANNEL_REQUEST:\n\t\tcase _channel2.default.UPDATE_CHANNEL_REQUEST:\n\t\tcase _channel2.default.SUBSCRIBETO_CHANNEL_REQUEST:\n\t\tcase _channel2.default.UNSUBSCRIBEFROM_CHANNEL_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: true,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tcase _channel2.default.CREATE_NEW_CHANNEL_SUCCESS:\n\t\tcase _channel2.default.UPDATE_CHANNEL_SUCCESS:\n\t\tcase _channel2.default.SUBSCRIBETO_CHANNEL_SUCCESS:\n\t\tcase _channel2.default.UNSUBSCRIBEFROM_CHANNEL_SUCCESS:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tsingle: payload\n\t\t\t});\n\n\t\tcase _channel2.default.CREATE_NEW_CHANNEL_ERROR:\n\t\tcase _channel2.default.UPDATE_CHANNEL_ERROR:\n\t\tcase _channel2.default.SUBSCRIBETO_CHANNEL_ERROR:\n\t\tcase _channel2.default.UNSUBSCRIBEFROM_CHANNEL_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tisError: payload\n\t\t\t});\n\t\tcase _channel2.default.GET_CHANNEL_BY_SLUG_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: true,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNEL_BY_SLUG_SUCCESS:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tsingle: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNEL_BY_SLUG_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tisError: payload\n\t\t\t});\n\t\tcase _channel2.default.GET_CHANNEL_MEDIA_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: true,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNEL_MEDIA_SUCCESS:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tsingle: _extends({}, state.single, {\n\t\t\t\t\tmedias: payload\n\t\t\t\t})\n\t\t\t});\n\n\t\tcase _channel2.default.GET_CHANNEL_MEDIA_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: false,\n\t\t\t\tisError: payload\n\t\t\t});\n\n\t\tdefault:\n\t\t\treturn state;\n\t}\n};\n\nexports.default = channelReducer;\n\n//# sourceURL=webpack:///./src/store/states/channel/channel.reducer.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _createActionStrings = __webpack_require__(/*! ../utils/create-action-strings */ \"./src/store/states/utils/create-action-strings.js\");\n\nvar _createActionStrings2 = _interopRequireDefault(_createActionStrings);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst getChannelsTopicsTypes = (0, _createActionStrings2.default)('GET_CHANNELS_TOPICS', 'Create channel modal');\nconst getUserSubscriptionsTypes = (0, _createActionStrings2.default)('GET_USER_SUBSCRIPTIONS', 'Sidedrawer');\nconst createNewChannelTypes = (0, _createActionStrings2.default)('CREATE_NEW_CHANNEL', 'Create channel modal');\nconst getChannelBySlugTypes = (0, _createActionStrings2.default)('GET_CHANNEL_BY_SLUG', 'Create channel modal');\nconst getChannelMediaTypes = (0, _createActionStrings2.default)('GET_CHANNEL_MEDIA', 'Channel page');\nconst updateChannelTypes = (0, _createActionStrings2.default)('UPDATE_CHANNEL', 'Channel page');\nconst subscribeToChannelTypes = (0, _createActionStrings2.default)('SUBSCRIBETO_CHANNEL', 'Channel page');\nconst unsubscribeFromChannelTypes = (0, _createActionStrings2.default)('UNSUBSCRIBEFROM_CHANNEL', 'Channel page');\n\nexports.default = _extends({}, getChannelsTopicsTypes, getUserSubscriptionsTypes, createNewChannelTypes, getChannelBySlugTypes, getChannelMediaTypes, updateChannelTypes, subscribeToChannelTypes, unsubscribeFromChannelTypes);\n\n//# sourceURL=webpack:///./src/store/states/channel/channel.types.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _createActionStrings = __webpack_require__(/*! ../utils/create-action-strings */ \"./src/store/states/utils/create-action-strings.js\");\n\nvar _createActionStrings2 = _interopRequireDefault(_createActionStrings);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst getCommentsTypes = (0, _createActionStrings2.default)('GET_COMMENTS', 'Single media page');\nconst postCommentTypes = (0, _createActionStrings2.default)('POST_COMMENT', 'Single media page');\nconst getRepliesByCommentTypes = (0, _createActionStrings2.default)('GET_REPLIES_BY_COMMENT', 'Comments single media page');\nconst likeCommentTypes = (0, _createActionStrings2.default)('LIKE_COMMENT', 'Comments single media page');\nconst dislikeCommentTypes = (0, _createActionStrings2.default)('DISLIKE_COMMENT', 'Comments single media page');\n\nconst POST_REPLY_SUCCESS = 'Api response/POST_REPLY_SUCCESS';\n\nexports.default = _extends({}, getCommentsTypes, postCommentTypes, getRepliesByCommentTypes, likeCommentTypes, dislikeCommentTypes, {\n\tPOST_REPLY_SUCCESS\n});\n\n//# sourceURL=webpack:///./src/store/states/comment/comment.types.js?");
...
/***/ "./src/store/states/media/media-reducers/CRUD/create-media.reducer.js":
/*!****************************************************************************!*\
  !*** ./src/store/states/media/media-reducers/CRUD/create-media.reducer.js ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/store/states/media/media-reducers/channel-media.reducer.js":
/*!************************************************************************!*\
  !*** ./src/store/states/media/media-reducers/channel-media.reducer.js ***!
  \************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _media = __webpack_require__(/*! ../media.initial-state */ \"./src/store/states/media/media.initial-state.js\");\n\nvar _media2 = _interopRequireDefault(_media);\n\nvar _media3 = __webpack_require__(/*! ../media.types */ \"./src/store/states/media/media.types.js\");\n\nvar _media4 = _interopRequireDefault(_media3);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst getChannelMediaList = (state = _media2.default, action) => {\n\tconst { type, payload } = action;\n\tswitch (type) {\n\t\tcase _media4.default.LIST_USER_MEDIA_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tchannel: true\n\t\t\t\t}),\n\t\t\t\tisError: _extends({}, state.isError, {\n\t\t\t\t\tchannel: null\n\t\t\t\t})\n\t\t\t});\n\n\t\tcase _media4.default.LIST_USER_MEDIA_SUCCESS:\n\t\t\tlet byIds = {};\n\t\t\tpayload.medias.forEach(item => {\n\t\t\t\tbyIds[item._id] = _extends({}, item, { type: 'channel' });\n\t\t\t});\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tchannel: false\n\t\t\t\t}),\n\t\t\t\tchannel: {\n\t\t\t\t\tallIds: Object.keys(byIds),\n\t\t\t\t\tbyId: byIds\n\t\t\t\t}\n\t\t\t});\n\n\t\tcase _media4.default.LIST_USER_MEDIA_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tchannel: false\n\t\t\t\t}),\n\t\t\t\tisError: _extends({}, state.isError, {\n\t\t\t\t\tchannel: payload\n\t\t\t\t})\n\t\t\t});\n\t\tdefault:\n\t\t\treturn state;\n\t}\n};\n\nexports.default = getChannelMediaList;\n\n//# sourceURL=webpack:///./src/store/states/media/media-reducers/channel-media.reducer.js?");

/***/ }),

/***/ "./src/store/states/media/media-reducers/continue-watching.reducer.js":
/*!****************************************************************************!*\
  !*** ./src/store/states/media/media-reducers/continue-watching.reducer.js ***!
  \****************************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _media = __webpack_require__(/*! ../media.initial-state */ \"./src/store/states/media/media.initial-state.js\");\n\nvar _media2 = _interopRequireDefault(_media);\n\nvar _media3 = __webpack_require__(/*! ../media.types */ \"./src/store/states/media/media.types.js\");\n\nvar _media4 = _interopRequireDefault(_media3);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst continueWatching = (state = _media2.default, action) => {\n\tconst { type, payload } = action;\n\tswitch (type) {\n\t\tcase _media4.default.LIST_CONTINUE_WATCHING_REQUEST:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tcontinueWatching: true\n\t\t\t\t}),\n\t\t\t\tisError: _extends({}, state.isError, {\n\t\t\t\t\tcontinueWatching: null\n\t\t\t\t})\n\t\t\t});\n\t\tcase _media4.default.LIST_CONTINUE_WATCHING_SUCCESS:\n\n\t\t\tlet items,\n\t\t\t    total = 0,\n\t\t\t    byIds = {};\n\t\t\tif (typeof payload === 'object') {\n\t\t\t\titems = payload.medias;\n\t\t\t\ttotal = payload.total;\n\t\t\t} else {\n\t\t\t\titems = payload;\n\t\t\t}\n\t\t\titems.forEach(item => {\n\t\t\t\tbyIds[item._id] = _extends({}, item, { type: 'media' });\n\t\t\t});\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tcontinueWatching: false\n\t\t\t\t}),\n\t\t\t\tcontinueWatching: {\n\t\t\t\t\tallIds: Object.keys(byIds),\n\t\t\t\t\tbyId: byIds\n\t\t\t\t}\n\t\t\t});\n\n\t\tcase _media4.default.LIST_CONTINUE_WATCHING_ERROR:\n\t\t\treturn _extends({}, state, {\n\t\t\t\tprocessing: _extends({}, state.processing, {\n\t\t\t\t\tcontinueWatching: false\n\t\t\t\t}),\n\t\t\t\tisError: _extends({}, state.isError, {\n\t\t\t\t\tcontinueWatching: payload\n\t\t\t\t})\n\t\t\t});\n\t\tdefault:\n\t\t\treturn state;\n\t}\n};\n\nexports.default = continueWatching;\n\n//# sourceURL=webpack:///./src/store/states/media/media-reducers/continue-watching.reducer.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };\n\nvar _createActionStrings = __webpack_require__(/*! ../utils/create-action-strings */ \"./src/store/states/utils/create-action-strings.js\");\n\nvar _createActionStrings2 = _interopRequireDefault(_createActionStrings);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nconst createMediaTypes = (0, _createActionStrings2.default)('CREATE_MEDIA', 'Newmedia page');\nconst listPopularMediaTypes = (0, _createActionStrings2.default)('LIST_POPULAR_MEDIA', 'Home page');\nconst listUserMediaTypes = (0, _createActionStrings2.default)('LIST_USER_MEDIA', 'Profile page');\nconst listRelatedMediaTypes = (0, _createActionStrings2.default)('LIST_RELATED_MEDIA', 'Single media page');\nconst listHistoryMediaTypes = (0, _createActionStrings2.default)('LIST_HISTORY_MEDIA', 'History media page');\nconst listWatchLaterMediaTypes = (0, _createActionStrings2.default)('LIST_WATCHLATER_MEDIA', 'Watch later media page');\nconst listMediaByChannelTypes = (0, _createActionStrings2.default)('LIST_MEDIA_BY_CHANNEL', 'Channel page');\nconst listContinueWatchingTypes = (0, _createActionStrings2.default)('LIST_CONTINUE_WATCHING', 'Home page');\nconst readMediaTypes = (0, _createActionStrings2.default)('READ_MEDIA', 'Single media page');\nconst removeMediaTypes = (0, _createActionStrings2.default)('REMOVE_MEDIA', 'Single media page');\nconst updateMediaTypes = (0, _createActionStrings2.default)('UPDATE_MEDIA', 'Edit media page');\nconst likeMediaTypes = (0, _createActionStrings2.default)('LIKE_MEDIA', 'Single media page');\nconst dislikeMediaTypes = (0, _createActionStrings2.default)('DISLIKE_MEDIA', 'Single media page');\nconst searchMediaTypes = (0, _createActionStrings2.default)('SEARCH_MEDIA', 'Main nav search');\nconst searchHistoryTypes = (0, _createActionStrings2.default)('SEARCH_HISTORY', 'History page search');\nconst searchWatchLaterTypes = (0, _createActionStrings2.default)('SEARCH_WATCHLATER', 'Watchlater page search');\n\nconst REPLACE_MEDIA_FROM_LIST = 'Single media page autoplay/REPLACE_MEDIA_FROM_LIST';\nconst RESET_HISTORY_LIST = 'History page search/RESET_HISTORY_LIST';\n\nexports.default = _extends({}, createMediaTypes, listPopularMediaTypes, listUserMediaTypes, listRelatedMediaTypes, listHistoryMediaTypes, listWatchLaterMediaTypes, listMediaByChannelTypes, listContinueWatchingTypes, readMediaTypes, searchMediaTypes, searchHistoryTypes, updateMediaTypes, removeMediaTypes, likeMediaTypes, dislikeMediaTypes, searchWatchLaterTypes, {\n\tREPLACE_MEDIA_FROM_LIST,\n\tRESET_HISTORY_LIST\n});\n\n//# sourceURL=webpack:///./src/store/states/media/media.types.js?");
...
/***/ "./src/store/states/utils/create-action-strings.js":
/*!*********************************************************!*\
  !*** ./src/store/states/utils/create-action-strings.js ***!
  \*********************************************************/
/*! no static exports found */
...
eval("module.exports = __webpack_require__(/*! /home/pavel/code/react/reactube/server/server.js */\"./server/server.js\");\n\n\n//# sourceURL=webpack:///multi_./server/server.js?");
...
/***/ "react-avatar-editor":
/*!**************************************!*\
  !*** external "react-avatar-editor" ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = require(\"react-avatar-editor\");\n\n//# sourceURL=webpack:///external_%22react-avatar-editor%22?");
...
eval("module.exports = require(\"seneca\");\n\n//# sourceURL=webpack:///external_%22seneca%22?");
